...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        settings = dict(
            ...
            login_url="/vkauth",
            client_secret="gArppBus07Z5ORfBlsDi",
            client_id=2318138,
        )
...
class VKHandler(tornado.web.RequestHandler, VKMixin):
    ...
    def get(self):
        ...
        self.authorize_redirect(client_id=self.settings["client_id"], redirect_uri="http://127.0.0.1:8000/vkauth", extra_params=args)
...
class MainHandler(BaseHandler):
    @tornado.web.authenticated
    def get(self):
        name = tornado.escape.xhtml_escape(self.current_user["response"][0]["first_name"])
